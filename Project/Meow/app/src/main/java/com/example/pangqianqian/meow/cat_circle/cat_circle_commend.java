...
public class cat_circle_commend extends Activity {
    ...
    //需要适配的数据
    private String[] names={"詹萍","李洁莹","陈玉淋","庞倩婷"};

    //需要适配的头像图片
    private int[] head_photo ={R.drawable.zp,R.drawable.lhh,R.drawable.cyl,R.drawable.pqt};

    //需要适配的猫圈语句
    private String[] content={"今日份撸猫+1","喵喵喵？情侣头像","赵淦森老师找我要猫咪地图耶！","开始吸猫后发现猫咪很可爱"};

    //需要适配的照片1
    private int[] photo_1={R.drawable.zp_1,R.drawable.lhh_1,R.drawable.cyl_1,R.drawable.pqt_1};

    //需要适配的照片2
    private int[] photo_2={R.drawable.zp_2,R.drawable.lhh_2,R.drawable.cyl_2,R.drawable.pqt_2};
    ...
    class MyBaseAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            View view=View.inflate(cat_circle_commend.this, R.layout.cat_circle_list_item,null);
            //为猫圈加名字
